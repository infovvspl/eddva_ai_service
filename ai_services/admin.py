...
class InstituteAdmin(admin.ModelAdmin):
    list_display = ("name", "slug", "vertical", "plan", "is_active", "daily_soft_cap", "daily_hard_cap", "max_concurrent_requests", "created_at")
    list_filter = ("vertical", "plan", "is_active")
    search_fields = ("name", "slug", "contact_email")
    readonly_fields = ("id", "api_key", "created_at", "updated_at")
    fieldsets = (
        ("Identity", {"fields": ("id", "name", "slug", "vertical", "api_key", "external_tenant_id", "contact_email", "is_active")}),
...
class UsageLogAdmin(admin.ModelAdmin):
    list_display = ("institute_id_str", "vertical", "feature", "model_used", "total_tokens", "cache_hit", "latency_ms", "created_at")
    list_filter = ("vertical", "institute_id_str", "feature", "cache_hit", "model_used")
    date_hierarchy = "created_at"
    readonly_fields = ("institute", "institute_id_str", "vertical", "feature", "model_used", "prompt_tokens", "completion_tokens", "total_tokens", "latency_ms", "cache_hit", "created_at")
